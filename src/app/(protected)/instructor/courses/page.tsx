...
export default function InstructorCoursesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {courses.length === 0 ? (
        <div className="rounded-xl border border-dashed border-zinc-350 p-16 text-center bg-white shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 rounded-xl border border-zinc-200 bg-white shadow-sm">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg border py-2 px-2 text-xs font-semibold transition-colors ${
                  sortBy === 'title' ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'bg-white border-zinc-300 text-zinc-650 hover:bg-zinc-50'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg border py-2 px-2 text-xs font-semibold transition-colors ${
                  sortBy === 'enrollmentCount' ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'bg-white border-zinc-300 text-zinc-650 hover:bg-zinc-50'
                }`}
              >
            ...
            {/* Counter display */}
            <div className="flex items-center justify-end text-xs font-semibold text-zinc-500 px-2 gap-1 bg-zinc-50 rounded-lg border border-zinc-150 py-2 sm:py-0">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1 rounded-lg border border-zinc-200 bg-white hover:bg-zinc-55/10 py-2 text-xs font-semibold text-zinc-700 transition-colors cursor-pointer"
                    >
